  ...
  public async loadSpriteSheet(imageUrl: string): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      img.onload = () => {
        ...
        this.totalFrames = Math.floor(img.width / this.spriteCellSize);
        this.parsedFrames = [];
        ...
        for (let f = 0; f < this.totalFrames; f++) {
          ...
          ctx.drawImage(img, f * this.spriteCellSize, 0, this.spriteCellSize, this.spriteCellSize, 0, 0, this.spriteCellSize, this.spriteCellSize);
